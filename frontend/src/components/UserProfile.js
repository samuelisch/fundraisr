...
const UserProfile = () => {
  ...
  <div className="flex flex-row justify-between mt-10">
    <div id="donation">
      <h2 className="text-base font-bold p-2 text-gray-700">Recent Donations:</h2>
          ...
          <table class="table-auto">
            <thead>
              <tr>
                ...
                <th className="border-b dark:border-slate-600 font-medium p-4 pr-8 pt-0 pb-3 text-slate-400 dark:text-slate-200 text-left">Amount Donated</th>
              </tr>
            </thead>
            <tbody>
            {donationsView}
    ...
    <div id="campaignlist">
      <h2 className="text-base font-bold p-2 text-gray-700">Campaigns Initiated</h2>
      <div className="relative rounded-xl overflow-auto">
        <div className="shadow-sm overflow-hidden my-5">
          <table class="table-auto">
            <thead>
              <tr>
                <th className="border-b dark:border-slate-600 font-medium p-4 pl-8 pt-0 pb-3 text-slate-400 dark:text-slate-200 text-left">Title</th>
                <th className="border-b dark:border-slate-600 font-medium p-4 pr-8 pt-0 pb-3 text-slate-400 dark:text-slate-200 text-left">Days Left</th>
                <th className="border-b dark:border-slate-600 font-medium p-4 pr-8 pt-0 pb-3 text-slate-400 dark:text-slate-200 text-left">Progress to-date</th>
              </tr>
            </thead>
            <tbody>
            {campaignsView}
