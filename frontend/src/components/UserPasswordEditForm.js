...
const UserPasswordEditForm = ({ handleSubmit }) => {
  ...
  return (
    ...
    <form onSubmit={submitHandler}>
      <label htmlFor="oldPassword" className="text-gray-700 ml-5">Current password:</label>
      <Input
      ...
      />
      <label htmlFor="newPassword" className="text-gray-700 ml-5">New password:</label>
      <Input
        className="border-2 border-blue-600 rounded-lg p-1  m-3"
        type="password"
        name="newPassword"
